...
class GPT:
    ...
    def _build_prompt_template(
        ...
        """
        prompt = f"""You are a professional video script generator. Generate a video script based on the following information:
...
- Create 1-3 text overlays that complement the video content
